        ...
        <div className={styles.fixedNav}>
          ...
          >
            <div className={styles.logo}>
              <Link to="/" className={styles.logo} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave}>Samarjit Mahi</Link>
            </div>
            ...
            <motion.div className={styles.half} variants={halfVariants}
              ...
              <div className={styles.wrapper}>
                ...
                <motion.div className={styles.socialIcons}>
                  <Link to="https://twitter.com/hisamarmahi">
                    <img
                      src={twitterIcon} 
                      alt="Twitter Icon" 
                  ...
                  <Link to="https://www.linkedin.com/in/samarjit-mahi/">
                    <img
                      src={linkedinIcon} 
                      alt="LinkedIn Icon" 
                      className={styles.social} 
